 ...
 */
public class FragmentChat extends EaseBaseFragment implements EMEventListener {
...
//        getActivity().requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // 会话人或群组id
        toChatUsername = fragmentArgs.getString(EaseConstant.EXTRA_USER_ID, ChatHelper.serviceID);
